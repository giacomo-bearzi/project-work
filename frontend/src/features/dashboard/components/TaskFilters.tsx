import { Box, Stack, TextField, Select, MenuItem, InputAdornment, Checkbox, ListItemText, useTheme } from '@mui/material';
                ...
                >
                    {statusOptions.map(option => (
                        <MenuItem key={option} value={option}>
                            ...
                            <ListItemText primary={option === 'in_attesa' ? 'In attesa' : option === 'in_corso' ? 'In corso' : 'Completata'} />
                        </MenuItem>
                    ))}
                </Select>
                <Select
