  ...
  useEffect(() => {
    if (open) {
      if (initialValues) {
        ...
        setCreatedAt(
          initialValues.createdAt ? getUTCDateTimeLocalString(initialValues.createdAt) : ''
        );
        setResolvedAt(
          initialValues.resolvedAt ? getUTCDateTimeLocalString(initialValues.resolvedAt) : ''
        );
      } else {
        setDescription('');
        setLine('');
      ...
      <CustomPaper sx={{ p: 2 }}>
        ...
        >
          ...
          {initialValues && onDelete && (
            <Button onClick={onDelete} color="error" startIcon={<DeleteIcon />} sx={{ ml: 2 }}>
              Elimina
            </Button>
          )}
        </DialogTitle>
            ...
            <Stack spacing={2}>
              ...
              <Stack direction="row" spacing={2}>
                <FormControl fullWidth required>
                  ...
                  <Select value={line} label="Linea" onChange={(e) => setLine(e.target.value)}>
                    {lineOptions.map((opt) => (
              ...
              <Stack direction="row" spacing={2}>
                ...
                <FormControl fullWidth required>
                  ...
                  <Select value={status} label="Stato" onChange={(e) => setStatus(e.target.value)}>
              ...
              {currentUser.role === 'operator' ? (
                ...
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField {...params} label="Segnalata da" required fullWidth />
                  )}
